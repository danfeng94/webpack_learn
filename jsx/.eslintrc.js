module.exports = {
    ...
    rules: {
        ...
        'func-names': 'off',
        /** Bad name 黑名单 */
        'id-blacklist': ['error', 'any', 'Number', 'number', 'string', 'boolean', 'Boolean', 'Undefined'],
        /** 使用正则匹配到的变量名、函数名报错 */
        'id-match': 'error',
        /** 单文件内允许的最大类数量 */
        ...
        'no-shadow': [
            'error',
            {
                ...
                hoist: 'functions',
                allow: ['args', 'item', 'hisory', 'History', 'prev', 'e', 'error', 'value'],
            },
        ],
        /** 禁止在普通字符串中使用插值关键字 */
        ...
        '@typescript-eslint/naming-convention': [
            'warn',
            {
                ...
                filter: {
                    // 忽略部分无法控制的命名
                    regex: '^(__html|zh_CNS|zh_CNT|en_US|_ga|SignUp_.*|Crm_.*)$',
                    match: false,
                },
            },
            {
            ...
            },
            {
                ...
                filter: {
                    // 忽略部分无法控制的命名
                    regex: '^(__html|zh_CNS|zh_CNT|en_US|_ga|SignUp_.*|Crm_.*|UNSAFE_.*)$',
                    match: false,
                },
            },
            {
        ...
        /** next.js 项目可关闭该规则，会自动引入 react 依赖 */
